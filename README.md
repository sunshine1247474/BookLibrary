**Welcome to the Book Library Project! ** This is a virtual space where book collectors and people with an introductory level of code can unite as different levels of programmers, and try out, modify, or build this project to the next level. Had an idea of digital book library, want to get inspired for similar project with algorithms or just curious? Maybe this is the right place.
